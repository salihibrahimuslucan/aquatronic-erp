...
-- ─── Seri no takibi (üretilen cihaz birimleri) ─────────────────────────────
...
do $$ declare t text;
begin
    foreach t in array array['items','stock_moves','boms','production_orders','pool_tests','outsource_jobs','activity_log','unit_serials'] loop
